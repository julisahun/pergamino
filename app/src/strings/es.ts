...
export const es = {
  ...
  revelarNiebla: 'Revelar niebla',
  ocultarNiebla: 'Cubrir de niebla',
  circulo: 'Círculo',
  cono: 'Cono',
  linea: 'Línea',
  pincel: 'Pincel',
  tamano: 'Tamaño',
  nieblaOn: 'Niebla activa',
  nieblaOff: 'Niebla apagada',
  revelarTodo: 'Revelar todo',
  cubrirTodo: 'Cubrir todo',
  colocarFichas: 'Colocar fichas',
  limpiarPlantillas: 'Limpiar plantillas',
  rejilla: 'Rejilla',
