...
export const es = {
  ...
  quitarDeLaCampana: 'Quitar de la mesa',
  confirmarQuitar: '¿Quitar a este personaje de la mesa? Se pierde su ficha y lo que llevaba encima, en ésta y en cualquier otra campaña que juegue esta mesa.',
  sinPersonajes: 'Todavía no hay personajes: reparte el enlace, o sube una ficha aquí.',
  nuevaSesion: 'Nueva sesión',
  nuevaSesionAyuda: 'Archiva la partida y despeja la mesa: PNJ, combate y escena. Lo que lleva la party —PG, oro, inventario— se queda como está.',
  ...
  sinEnlaceAyuda: 'Pide al DM el enlace de la mesa y ábrelo tal cual.',
